      ...
      <div className="container">
        <div className="row pt-5">
          <div className="col-12 col-lg-6 offset-lg-3" style={{ textAlign:"center"}}>
            <h1 className="text-center">BoilerBlog (React Project)</h1>
            <a style={{justifyContent: "center"}} href="https://blog.cloudboost.io/learn-how-to-create-a-simple-blog-with-react-node-c05fa6889de3">
              Based on a React tutorial by Antonio Erdeljac
            </a>
          </div>
          <Form />
        </div>
